...
import {Component, OnInit, OnChanges, ElementRef, Inject, Input, OnDestroy, SimpleChanges} from '@angular/core';
...
export class nvD3 implements OnChanges, OnDestroy{
